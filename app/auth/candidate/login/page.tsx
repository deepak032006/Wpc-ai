      ...
      <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-5 sm:p-6 md:p-8">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 md:space-y-5">
          ...
          <div className="flex items-center justify-between text-xs md:text-sm">
            <Link href="/welcome/forgot-password/candidate" className="text-blue-600 hover:underline">
              Forgot Password?
            </Link>
          </div>
          ...
          <div className="text-center text-xs md:text-sm text-gray-600">
            ...
            <Link href="/auth/candidate/register" className="text-blue-600 hover:underline font-medium">
              Create Account
            </Link>
          </div>
        </form>
