...
import { Play, MapPin, Calendar, Clock, Award, Briefcase, FileText, Video } from 'lucide-react';
...
const CandidatePage = () => {
    ...
    const candidate = candidateData ? {
        ...
        yearsExperience: candidateData.cv_parsed_data?.employment_history?.position_start_date 
            ? new Date().getFullYear() - new Date(candidateData.cv_parsed_data.employment_history.position_start_date).getFullYear()
            : 0,
        ...
        qualifications: candidateData.cv_parsed_data?.education_qualification ? [{
            ...
            year: candidateData.cv_parsed_data.education_qualification.end_date || 'N/A'
        }] : [],

        experience: candidateData.cv_parsed_data?.employment_history ? [{
            title: candidateData.cv_parsed_data.employment_history.current_position,
            company: candidateData.cv_parsed_data.employment_history.company_name,
            period: `${candidateData.cv_parsed_data.employment_history.position_start_date || 'N/A'} – Present`,
            description: candidateData.cv_parsed_data.professional_summary || 'No description available'
        }] : [],

        interviewNotes: 'Excellent communication skills. Demonstrated strong knowledge of safeguarding procedures. Very personable and caring demeanor.',
        ...
        experience: [
            {
                ...
                period: '2021 – Present',
                description: 'Leading a team of 5 care assistants, providing person-centered care to 20+ residents.'
            },
            {
                title: 'Care Assistant',
                company: 'Harmony Healthcare',
                period: '2018 – 2021',
                description: 'Provided daily care support including personal hygiene, medication, and mobility assistance.'
            }
        ],
                        ...
                        <div className="lg:col-span-2 space-y-5">
                            <div className="bg-white rounded-md p-6 shadow-sm">
                                ...
                                <div className="flex flex-wrap gap-2.5">
                                    {[1, 2, 3, 4, 5, 6].map((i) => (
                                        <div key={i} className="h-8 w-24 shimmer rounded-full"></div>
                                    ))}
                                </div>
                            </div>
                    ...
                    <div className="flex items-start justify-between">
                        <div className="flex gap-5 items-start">
                            ...
                            <div className="flex-1 ">
                                ...
                                <p className="text-[15px] text-[#FFFFFF] font-medium mb-4">Candidate #{candidate.id}</p>
                        ...
                        <div className="bg-[#B0D4FD38] bg-opacity-20 backdrop-blur-sm text-white px-4 py-1 rounded-full border border-white border-opacity-30">
                            <div className="flex items-center gap-2">
                                <span className="text-[15px] font-medium">{cnScore}% Match</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-2 space-y-5">
                        <div className="bg-white rounded-md p-6 shadow-sm shadow-[#094F9E0F]">
                            <div className="flex items-center gap-2.5 mb-5">
                                ...
                                <h2 className="text-[18px] font-semibold text-[#111827]">Skills & Competencies</h2>
                            </div>
                            <div className="flex flex-wrap gap-2.5">
                        ...
                        <div className="bg-white rounded-md p-6 shadow-sm shadow-[#094F9E0F]">
                            <div className="flex items-center gap-2.5 mb-5">
                                ...
                                <h2 className="text-[18px] font-semibold text-[#111827]">Qualifications</h2>
                            </div>
                            <div className="space-y-3">
                                {candidate.qualifications.map((qual, index) => (
                                    ...
                                    >
                                        <span className="font-medium text-[#151515] text-[15px]">{qual.name}</span>
                        ...
                        <div className="bg-white rounded-md p-6 shadow-sm shadow-[#094F9E0F]">
                            <div className="flex items-center gap-2.5 mb-5">
                                ...
                                <h2 className="text-[18px] font-semibold text-[#111827]">Work Experience</h2>
                            </div>
                                ...
                                {candidate.experience.map((exp, index) => (
                                    <div key={index} className="relative">
                                        ...
                                        <div className="bg-[#f9fafbmdrounded-lg p-5 shadow-[#094F9E0F] transition-colors duration-200 hover:bg-[#f3f4f6]">
                                            <h3 className="font-bold text-[16px] text-[#181818] mb-1">{exp.title}</h3>
                                            <div className="flex flex-col items-start gap-3 mb-3">
                                                <span className="text-[#0852C9] font-medium text-[14px]">{exp.company}</span>
                                                <span className="text-[#3C3A3A] font-medium text-[14px]">{exp.period}</span>
                                            </div>
                                            <p className="text-[#3C3A3A] leading-relaxed text-[14px]">{exp.description}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
