...
export default function ReviewPage() {
  ...
  const [localFormData, setLocalFormData] = useState<JobRoleType>({});
  ...
  // New states for markdown editor
  ...
  // for loading the job data handler
  ...
  const handleSaveField = (field: string) => {
    if (field === "responsibilities") {
      const list = (localFormData.responsibilities || []).map(r => r.trim());
    ...
    if (field === "skills") {
      const list = (localFormData.skills || []).map(s => s.trim());
    ...
    <div className="w-full max-w-4xl mx-auto p-6">
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col pb-4">
          ...
          <div className="flex justify-between items-start py-2">
            <div className="flex-1">
              ...
              {editingField === 'job_type' ? (
                ...
                <p className="text-sm text-gray-700">
                  {localFormData.job_type?.name || "Not specified"}
                </p>
              )}
            </div>
            {editingField !== 'job_type' && (
          ...
          {/* Job Location */}
          {(localFormData.job_location || editingField === 'job_location') && (
            <div className="flex justify-between items-start py-2">
              <div className="flex-1">
...
- Qualification 2"
      ...
      <div className="border-t border-gray-300 mt-8 pt-6 flex flex-row-reverse justify-between gap-5">
